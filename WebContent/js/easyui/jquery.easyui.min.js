...
mobile: {//value值为文本框中的值  
    ...
    message: '输入手机号码格式不准确.'  
},length:{validator:function(_44e,_44f){
...
_972(this,q);
}},currentText:"Today",clearText:"Clear",closeText:"Close",okText:"Ok",buttons:[{text:function(_985){
...
{text:function(_1006){
	return $(_1006).datebox("options").clearText;
